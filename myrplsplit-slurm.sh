...
#SBATCH -o rplspl.%N.%j.out # STDOUT
#SBATCH -e rplspl.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:475636311313:awsnotify --message "JobDone"
